...
namespace DahlDesignPropertiesNG
{
    ...
    public class DahlDesignPlugin : IPlugin, IDataPlugin, IWPFSettingsV2
    {
        ...
        private void SetupProperties()
        {
            ...
            //s.AddProperty("DDUstartLED", Settings.DDUstartLED);
            //s.AddProperty("SW1startLED", Settings.SW1startLED);
            //s.AddProperty("DDUEnabled", Settings.DDUEnabled);
            //s.AddProperty("SW1Enabled", Settings.SW1Enabled);
            //s.AddProperty("DashLEDEnabled", Settings.DashLEDEnabled);
            //s.AddProperty("ShowMapEnabled", Settings.ShowMapEnabled);
            //s.AddProperty("DashType", Settings.DashType);
            //s.AddProperty("LapInfoScreen", Settings.LapInfoScreen);
            //s.AddProperty("ShiftTimingAssist", Settings.ShiftTimingAssist);
            //s.AddProperty("ShiftWarning", Settings.ShiftWarning);
            //s.AddProperty("ARBswapped", Settings.SupercarSwapPosition);
            //s.AddProperty("ARBstiffForward", Settings.SupercarARBDirection);
            //s.AddProperty("SmallFuelIncrement", Settings.SmallFuelIncrement);
            //s.AddProperty("LargeFuelIncrement", Settings.LargeFuelIncrement);
            //s.AddProperty("CoupleInCarToPit", Settings.CoupleInCarToPit);
